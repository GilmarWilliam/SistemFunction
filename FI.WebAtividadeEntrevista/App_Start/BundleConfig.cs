...
namespace FI.WebAtividadeEntrevista
{
    public class BundleConfig
    {
        ...
        public static void RegisterBundles(BundleCollection bundles)
        {
            ...
            bundles.Add(new ScriptBundle("~/bundles/fieldsValidation").Include(
                      "~/Scripts/Clientes/FI.FieldsValidation.js"));

            bundles.Add(new ScriptBundle("~/bundles/beneficiariosController").Include(
                      "~/Scripts/Beneficiarios/FI.BeneficiariosController.js"));
